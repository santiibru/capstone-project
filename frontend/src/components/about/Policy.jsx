...
export default function Policy () {
  ...
  <Container className='my-3'>
    <div>
      <h1>Privacy Policy of Grön Market SRL </h1>
      <p>Gron Market SRL operates the gronmarket.com website, which provides the SERVICE.

      This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Grön Market website.
      If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.
      The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at gronmarket.com, unless otherwise defined in this Privacy Policy. </p>
      ...
      Our Privacy Policy was created with the help of the Privacy Policy Template.</p>
